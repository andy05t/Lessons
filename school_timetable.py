...
for sub in ("Maths","Physics","Chemistry","Biology","Programming"):
    ...
    for _ in range (teacher_number):
        ...
        if teachers[sub][name] > 20:
            teachers[sub][name] = 20
            print("A teacher cannot teach more than 20 hours a week (80 hours a month), so as to not interfere with other lessons")
